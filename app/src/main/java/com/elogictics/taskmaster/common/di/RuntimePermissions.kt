package com.elogictics.taskmaster.common.di
...
class RuntimePermissions constructor(@NonNull private val activity: FragmentActivity):
     ...
     */
    fun requestPermissions(vararg permissions: String): RuntimePermissions {
     ...
     * @return This RuntimePermission object to allow for chaining of calls to set methods
     *
     * @see RuntimePermissions.showRationalePermission
     * @see AlertDialog.Builder.setPositiveButton
     * */
    fun setPositiveButton(@NonNull positiveText: String): RuntimePermissions {
     ...
     * */
    fun setNegativeButton(@NonNull negativeText: String): RuntimePermissions {
     ...
     * */
    fun setRationaleDialogCancelable(isCancelable: Boolean = true): RuntimePermissions {
     ...
     * @return This RuntimePermission object to allow for chaining of calls to set methods
     * */
    fun setDetailedPermissionRequired(isDetailedPermissionRequired: Boolean = false): RuntimePermissions {
