...
import com.elogictics.taskmaster.adapter.ImageViewAdapter
...
import com.elogictics.taskmaster.databinding.FragmentMediaDetailBinding
    ...
    private fun responseUploadMultiImage(uiState: UiState<Any>?) {
        when (uiState) {
            ...
            is UiState.Error -> {
                ...
                Log.e(MainActivity.TAG_ERROR, "responseUploadMultiImage: $errorMessage")
                LoadingScreen.hideLoading()
